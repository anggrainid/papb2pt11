...
public class PulseAnimationView extends View{
    ...
    private final Paint mPaint = new Paint(); //memberi color
    private static final int COLOR_ADJUSTER = 5; //perubahan color
    private float mX; //location atau position sisinya mau digamabar di mana
    private float mY;
    ...
    public void setRadius(float radius){
        ...
        invalidate(); //ready untuk menggambar sesuatu, tapi perlu override dulu
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        //ketika lagi start, diberhentiin dulu
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mPulseAnimatorSet.play(growAnimator).before(shrinkAnimator); //initialize mPulse, belum distart, start ketika viewnya diklik,
